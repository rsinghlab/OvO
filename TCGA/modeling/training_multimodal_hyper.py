...
def train_model(model_name, dataloaders, criterion, len_train, len_val, modality_shapes, config, path):
    ...
    Args:
        model_name (str): The name of the multimodal model to be trained (e.g., concat, OvO, cross, self).
...
def main():
    ...
    Arguments:
        model_name (str): The name of the model architecture to use (concat, OvO, cross, or self).
